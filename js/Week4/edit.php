...
<head>
    <title>Domantas Balciunas Edit Profile</title>
...
<body>
    <form>
        <div class="container">
            ...
            <form method="post">
                <p>First Name:
                    <input type="text" name="first_name" size="60" value="<?php echo $profile['first_name'] ?>" />
                </p>
                <p>Last Name:
                    <input type="text" name="last_name" size="60" value="<?php echo $profile['last_name'] ?>" />
                </p>
                <p>Email:
                    <input type="text" name="email" size="30" value="<?php echo $profile['email'] ?>" />
                </p>
                <p>Headline:<br />
                    <input type="text" name="headline" size="80" value="<?php echo $profile['headline'] ?>" />
                </p>
                <p>Summary:<br />
